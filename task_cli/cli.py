...
def _build_task_parser(sub: argparse._SubParsersAction) -> None:
    ...
    upd.add_argument("--assignee", dest="assignee_id", default=None, help="user record id, e.g. user:abc")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="task",
        description="Manage tasks (with activity history and comments) backed by SurrealDB",
    )
